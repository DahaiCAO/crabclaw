...
from crabclaw.config.paths import get_media_dir
...
class FeishuChannel(BaseChannel):
    ...
    async def _on_message(self, data: Any) -> None:
        ...
        try:
            ...
            logger.info("Feishu: received message - chat_type={}, msg_type={}, sender_type={}", 
                       message.chat_type, message.message_type, sender.sender_type)
            
            # Deduplication check
            message_id = message.message_id
            if message_id in self._processed_message_ids:
                logger.debug("Feishu: skipping duplicate message {}", message_id)
                return
            ...
            if sender.sender_type == "bot":
                logger.debug("Feishu: skipping bot message")
                return
